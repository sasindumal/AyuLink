// ==============================================
// AyuLink Pharmacy - Profile & Settings
//
        ...
        <SafeAreaView style={styles.safe} edges={["top"]}>
            ...
            {loading ? (
                ...
                <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.card}>
                        <Row label="Pharmacy" value={profile?.pharmacyProfile?.pharmacyName} />
                        <Row label="License number" value={profile?.pharmacyProfile?.licenseNumber} />
                    </View>
