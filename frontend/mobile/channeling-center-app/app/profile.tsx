// ==============================================
// AyuLink Channeling Center - Profile & Settings
//
        ...
        <SafeAreaView style={styles.safe} edges={["top"]}>
            ...
            {loading ? (
                ...
                <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
                    ...
                    <Text style={styles.sectionTitle}>Centre</Text>
                    <View style={styles.card}>
                        <Row label="Name" value={profile?.channelingCenter?.name} />
                        <Row label="Address" value={profile?.channelingCenter?.address} />
                        <Row label="City" value={profile?.channelingCenter?.city} />
                        <Row label="Contact" value={profile?.channelingCenter?.contactNumber} />
                    </View>
