// ==============================================
// AyuLink Channeling Center - Login
// NIC number + password
// ==============================================
...
export default function Login() {
    ...
    const submit = async () => {
        ...
        try {
            ...
            if (user.role !== "CHANNELING_CENTER") {
                await logout();
                setError("This app is for channeling centers. Please use the AyuLink app for your role.");
                setLoading(false);
                return;
            }
            ...
            >
                ...
                >
                    <View style={styles.brand}>
                        ...
                        <Text style={styles.title}>AyuLink Channeling Center</Text>
                        <Text style={styles.subtitle}>
                            Manage appointments at your center
                        </Text>
                    </View>
